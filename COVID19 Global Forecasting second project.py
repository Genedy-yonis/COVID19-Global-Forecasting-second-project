# url
# https://www.kaggle.com/atharvachute/simple-polynomial-regression-model
...
train = pd.read_csv(r"D:\ds\kaggle\COVID19 Global Forecasting (Week 4)/train.csv")
test = pd.read_csv(r"D:\ds\kaggle\COVID19 Global Forecasting (Week 4)/test.csv")
print()
train.info()
...
random_picks = random.choices(countriesorstates, k=1)
for value in random_picks:
    ...
    # print('=================train_temp_X============')
    # print(len(train_temp_X))
    # print('=================test_temp_X============')
    # print(len(test_temp_X))
...
for value in countriesorstates:
    ...
    print('======a=========')
    print(train["No. of days"].loc[train["Country/State"] == "India"])
    print('=======b========')
    print(test_temp["No. of days"])
    print('===============')
    print('======test_cc==first=======')
    print(test_cc)

    test_cc[0:b ] = sc_cc.inverse_transform(train_temp_cc)[(a - b ):(a)]
    test_ft[0:b ] = sc_ft.inverse_transform(train_temp_ft)[(a - b ):(a)]
    print('======test_cc[0:b ]==second=======')
    print(test_cc[0:b ])
    print('===============')
...
sub.to_csv(r"D:\ds\kaggle\COVID19 Global Forecasting (Week 4)\submission3.csv", index=False)
